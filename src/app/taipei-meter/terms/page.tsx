    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1a1a1a 0%, #2a2a2a 100%)', fontFamily: 'Noto Sans TC, Segoe UI, Arial, sans-serif', margin: 0 }}>
      ...
      <main style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 5vw', color: '#fff' }}>
        <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: 24, padding: '48px', backdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.1)' }}>
          <h1 style={{ color: '#C07D6D', fontSize: 48, fontWeight: 900, marginBottom: 32, textAlign: 'center', letterSpacing: 1 }}>Terms of Service</h1>

          <div style={{ marginBottom: 40 }}>
            <h2 style={{ color: '#FBCEBB', fontSize: 32, fontWeight: 700, marginBottom: 24, letterSpacing: 1 }}>Introduction</h2>
            <p style={{ fontSize: 18, lineHeight: 1.7, color: '#cbd5e1' }}>
              Welcome to Taipei Meter. By using our services, you agree to these Terms of Service.
            </p>
          </div>

          <div style={{ marginBottom: 40 }}>
            <h3 style={{ color: '#C07D6D', fontSize: 24, fontWeight: 600, marginBottom: 20 }}>Acceptable Use</h3>
          ...
          <div style={{ marginBottom: 40 }}>
            <h3 style={{ color: '#C07D6D', fontSize: 24, fontWeight: 600, marginBottom: 20 }}>Liability and Disclaimer</h3>
          ...
          <div style={{ marginBottom: 40 }}>
            <h3 style={{ color: '#C07D6D', fontSize: 24, fontWeight: 600, marginBottom: 20 }}>Changes to These Terms</h3>
            <p style={{ fontSize: 16, lineHeight: 1.7, color: '#cbd5e1' }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <p style={{ fontSize: 16, lineHeight: 1.7, color: '#cbd5e1' }}>
              If you have any questions about these terms, please contact us at <a href="mailto:mr.chi.service@gmail.com" style={{ color: '#C07D6D', textDecoration: 'underline' }}>mr.chi.service@gmail.com</a>
            </p>
          </div>
